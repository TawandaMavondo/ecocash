...
@JsonKey(name: 'destinationEcocashReference') String? get destinationEcocashReference;@JsonKey(name: 'clientMerchantCode') String? get clientMerchantCode;@JsonKey(name: 'clientMerchantNumber') String? get clientMerchantNumber;@JsonKey(name: 'clienttransactionDate') String? get clienttransactionDate;@JsonKey(name: 'description') String? get description;@JsonKey(name: 'responseMessage') String? get responseMessage;@JsonKey(name: 'currency') String? get currency;@JsonKey(name: 'ecocashReference') String? get ecocashReference;@JsonKey(name: 'transactionstartTime') String? get transactionstartTime;@JsonKey(name: 'transactionStatus') String? get transactionStatus;@JsonKey(name: 'amount') double get amount;@JsonKey(name: 'paymentAmount') double get paymentAmount;@JsonKey(name: 'sourceReference') String? get sourceReference;@JsonKey(name: 'transactionEndTime') String? get transactionEndTime;@JsonKey(name: 'callbackUrl') String? get callbackUrl;@JsonKey(name: 'destinationReferenceCode') String? get destinationReferenceCode;@JsonKey(name: 'sourceMobileNumber') String? get sourceMobileNumber;
...
@useResult
$Res call({
@JsonKey(name: 'destinationEcocashReference') String? destinationEcocashReference,@JsonKey(name: 'clientMerchantCode') String? clientMerchantCode,@JsonKey(name: 'clientMerchantNumber') String? clientMerchantNumber,@JsonKey(name: 'clienttransactionDate') String? clienttransactionDate,@JsonKey(name: 'description') String? description,@JsonKey(name: 'responseMessage') String? responseMessage,@JsonKey(name: 'currency') String? currency,@JsonKey(name: 'ecocashReference') String? ecocashReference,@JsonKey(name: 'transactionstartTime') String? transactionstartTime,@JsonKey(name: 'transactionStatus') String? transactionStatus,@JsonKey(name: 'amount') double amount,@JsonKey(name: 'paymentAmount') double paymentAmount,@JsonKey(name: 'sourceReference') String? sourceReference,@JsonKey(name: 'transactionEndTime') String? transactionEndTime,@JsonKey(name: 'callbackUrl') String? callbackUrl,@JsonKey(name: 'destinationReferenceCode') String? destinationReferenceCode,@JsonKey(name: 'sourceMobileNumber') String? sourceMobileNumber
});
...
/// Create a copy of RefundResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? destinationEcocashReference = freezed,Object? clientMerchantCode = freezed,Object? clientMerchantNumber = freezed,Object? clienttransactionDate = freezed,Object? description = freezed,Object? responseMessage = freezed,Object? currency = freezed,Object? ecocashReference = freezed,Object? transactionstartTime = freezed,Object? transactionStatus = freezed,Object? amount = null,Object? paymentAmount = null,Object? sourceReference = freezed,Object? transactionEndTime = freezed,Object? callbackUrl = freezed,Object? destinationReferenceCode = freezed,Object? sourceMobileNumber = freezed,}) {
  return _then(_self.copyWith(
destinationEcocashReference: freezed == destinationEcocashReference ? _self.destinationEcocashReference : destinationEcocashReference // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'destinationEcocashReference')  String? destinationEcocashReference, @JsonKey(name: 'clientMerchantCode')  String? clientMerchantCode, @JsonKey(name: 'clientMerchantNumber')  String? clientMerchantNumber, @JsonKey(name: 'clienttransactionDate')  String? clienttransactionDate, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'responseMessage')  String? responseMessage, @JsonKey(name: 'currency')  String? currency, @JsonKey(name: 'ecocashReference')  String? ecocashReference, @JsonKey(name: 'transactionstartTime')  String? transactionstartTime, @JsonKey(name: 'transactionStatus')  String? transactionStatus, @JsonKey(name: 'amount')  double amount, @JsonKey(name: 'paymentAmount')  double paymentAmount, @JsonKey(name: 'sourceReference')  String? sourceReference, @JsonKey(name: 'transactionEndTime')  String? transactionEndTime, @JsonKey(name: 'callbackUrl')  String? callbackUrl, @JsonKey(name: 'destinationReferenceCode')  String? destinationReferenceCode, @JsonKey(name: 'sourceMobileNumber')  String? sourceMobileNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RefundResponse() when $default != null:
return $default(_that.destinationEcocashReference,_that.clientMerchantCode,_that.clientMerchantNumber,_that.clienttransactionDate,_that.description,_that.responseMessage,_that.currency,_that.ecocashReference,_that.transactionstartTime,_that.transactionStatus,_that.amount,_that.paymentAmount,_that.sourceReference,_that.transactionEndTime,_that.callbackUrl,_that.destinationReferenceCode,_that.sourceMobileNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'destinationEcocashReference')  String? destinationEcocashReference, @JsonKey(name: 'clientMerchantCode')  String? clientMerchantCode, @JsonKey(name: 'clientMerchantNumber')  String? clientMerchantNumber, @JsonKey(name: 'clienttransactionDate')  String? clienttransactionDate, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'responseMessage')  String? responseMessage, @JsonKey(name: 'currency')  String? currency, @JsonKey(name: 'ecocashReference')  String? ecocashReference, @JsonKey(name: 'transactionstartTime')  String? transactionstartTime, @JsonKey(name: 'transactionStatus')  String? transactionStatus, @JsonKey(name: 'amount')  double amount, @JsonKey(name: 'paymentAmount')  double paymentAmount, @JsonKey(name: 'sourceReference')  String? sourceReference, @JsonKey(name: 'transactionEndTime')  String? transactionEndTime, @JsonKey(name: 'callbackUrl')  String? callbackUrl, @JsonKey(name: 'destinationReferenceCode')  String? destinationReferenceCode, @JsonKey(name: 'sourceMobileNumber')  String? sourceMobileNumber)  $default,) {final _that = this;
switch (_that) {
case _RefundResponse():
return $default(_that.destinationEcocashReference,_that.clientMerchantCode,_that.clientMerchantNumber,_that.clienttransactionDate,_that.description,_that.responseMessage,_that.currency,_that.ecocashReference,_that.transactionstartTime,_that.transactionStatus,_that.amount,_that.paymentAmount,_that.sourceReference,_that.transactionEndTime,_that.callbackUrl,_that.destinationReferenceCode,_that.sourceMobileNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'destinationEcocashReference')  String? destinationEcocashReference, @JsonKey(name: 'clientMerchantCode')  String? clientMerchantCode, @JsonKey(name: 'clientMerchantNumber')  String? clientMerchantNumber, @JsonKey(name: 'clienttransactionDate')  String? clienttransactionDate, @JsonKey(name: 'description')  String? description, @JsonKey(name: 'responseMessage')  String? responseMessage, @JsonKey(name: 'currency')  String? currency, @JsonKey(name: 'ecocashReference')  String? ecocashReference, @JsonKey(name: 'transactionstartTime')  String? transactionstartTime, @JsonKey(name: 'transactionStatus')  String? transactionStatus, @JsonKey(name: 'amount')  double amount, @JsonKey(name: 'paymentAmount')  double paymentAmount, @JsonKey(name: 'sourceReference')  String? sourceReference, @JsonKey(name: 'transactionEndTime')  String? transactionEndTime, @JsonKey(name: 'callbackUrl')  String? callbackUrl, @JsonKey(name: 'destinationReferenceCode')  String? destinationReferenceCode, @JsonKey(name: 'sourceMobileNumber')  String? sourceMobileNumber)?  $default,) {final _that = this;
switch (_that) {
case _RefundResponse() when $default != null:
return $default(_that.destinationEcocashReference,_that.clientMerchantCode,_that.clientMerchantNumber,_that.clienttransactionDate,_that.description,_that.responseMessage,_that.currency,_that.ecocashReference,_that.transactionstartTime,_that.transactionStatus,_that.amount,_that.paymentAmount,_that.sourceReference,_that.transactionEndTime,_that.callbackUrl,_that.destinationReferenceCode,_that.sourceMobileNumber);case _:
  return null;
...
/// Create a copy of RefundResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? destinationEcocashReference = freezed,Object? clientMerchantCode = freezed,Object? clientMerchantNumber = freezed,Object? clienttransactionDate = freezed,Object? description = freezed,Object? responseMessage = freezed,Object? currency = freezed,Object? ecocashReference = freezed,Object? transactionstartTime = freezed,Object? transactionStatus = freezed,Object? amount = null,Object? paymentAmount = null,Object? sourceReference = freezed,Object? transactionEndTime = freezed,Object? callbackUrl = freezed,Object? destinationReferenceCode = freezed,Object? sourceMobileNumber = freezed,}) {
