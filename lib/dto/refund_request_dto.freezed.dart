...
@JsonKey(name: 'amount') double get amount;@JsonKey(name: 'clientName') String get clientName;@JsonKey(name: 'currency') String get currency;@JsonKey(name: 'reasonForRefund') String get reasonForRefund;@JsonKey(name: 'origionalEcocashTransactionReference') String get originalEcocashTransactionReference;@JsonKey(name: 'refundCorelator') String get refundCorrelator;@JsonKey(name: 'sourceMobileNumber') String get sourceMobileNumber;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,amount,clientName,currency,reasonForRefund,originalEcocashTransactionReference,refundCorrelator,sourceMobileNumber);

@override
String toString() {
  return 'RefundRequest(amount: $amount, clientName: $clientName, currency: $currency, reasonForRefund: $reasonForRefund, originalEcocashTransactionReference: $originalEcocashTransactionReference, refundCorrelator: $refundCorrelator, sourceMobileNumber: $sourceMobileNumber)';
}
...
@useResult
$Res call({
@JsonKey(name: 'amount') double amount,@JsonKey(name: 'clientName') String clientName,@JsonKey(name: 'currency') String currency,@JsonKey(name: 'reasonForRefund') String reasonForRefund,@JsonKey(name: 'origionalEcocashTransactionReference') String originalEcocashTransactionReference,@JsonKey(name: 'refundCorelator') String refundCorrelator,@JsonKey(name: 'sourceMobileNumber') String sourceMobileNumber
});
...
/// Create a copy of RefundRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? amount = null,Object? clientName = null,Object? currency = null,Object? reasonForRefund = null,Object? originalEcocashTransactionReference = null,Object? refundCorrelator = null,Object? sourceMobileNumber = null,}) {
...
as String,originalEcocashTransactionReference: null == originalEcocashTransactionReference ? _self.originalEcocashTransactionReference : originalEcocashTransactionReference // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'amount')  double amount, @JsonKey(name: 'clientName')  String clientName, @JsonKey(name: 'currency')  String currency, @JsonKey(name: 'reasonForRefund')  String reasonForRefund, @JsonKey(name: 'origionalEcocashTransactionReference')  String originalEcocashTransactionReference, @JsonKey(name: 'refundCorelator')  String refundCorrelator, @JsonKey(name: 'sourceMobileNumber')  String sourceMobileNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RefundRequest() when $default != null:
return $default(_that.amount,_that.clientName,_that.currency,_that.reasonForRefund,_that.originalEcocashTransactionReference,_that.refundCorrelator,_that.sourceMobileNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'amount')  double amount, @JsonKey(name: 'clientName')  String clientName, @JsonKey(name: 'currency')  String currency, @JsonKey(name: 'reasonForRefund')  String reasonForRefund, @JsonKey(name: 'origionalEcocashTransactionReference')  String originalEcocashTransactionReference, @JsonKey(name: 'refundCorelator')  String refundCorrelator, @JsonKey(name: 'sourceMobileNumber')  String sourceMobileNumber)  $default,) {final _that = this;
switch (_that) {
case _RefundRequest():
return $default(_that.amount,_that.clientName,_that.currency,_that.reasonForRefund,_that.originalEcocashTransactionReference,_that.refundCorrelator,_that.sourceMobileNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'amount')  double amount, @JsonKey(name: 'clientName')  String clientName, @JsonKey(name: 'currency')  String currency, @JsonKey(name: 'reasonForRefund')  String reasonForRefund, @JsonKey(name: 'origionalEcocashTransactionReference')  String originalEcocashTransactionReference, @JsonKey(name: 'refundCorelator')  String refundCorrelator, @JsonKey(name: 'sourceMobileNumber')  String sourceMobileNumber)?  $default,) {final _that = this;
switch (_that) {
case _RefundRequest() when $default != null:
return $default(_that.amount,_that.clientName,_that.currency,_that.reasonForRefund,_that.originalEcocashTransactionReference,_that.refundCorrelator,_that.sourceMobileNumber);case _:
  return null;
...
class _RefundRequest extends RefundRequest {
  const _RefundRequest({@JsonKey(name: 'amount') required this.amount, @JsonKey(name: 'clientName') required this.clientName, @JsonKey(name: 'currency') required this.currency, @JsonKey(name: 'reasonForRefund') required this.reasonForRefund, @JsonKey(name: 'origionalEcocashTransactionReference') required this.originalEcocashTransactionReference, @JsonKey(name: 'refundCorelator') required this.refundCorrelator, @JsonKey(name: 'sourceMobileNumber') required this.sourceMobileNumber}): super._();
...
/// Create a copy of RefundRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? amount = null,Object? clientName = null,Object? currency = null,Object? reasonForRefund = null,Object? originalEcocashTransactionReference = null,Object? refundCorrelator = null,Object? sourceMobileNumber = null,}) {
